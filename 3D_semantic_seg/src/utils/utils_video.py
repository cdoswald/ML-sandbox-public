...
def vstack_videos(
    ...
    try:
        ...
        if video1_crop_height is not None and video1_crop_y_offset is not None:
            video1 = video1.filter("crop", output_resolution[0], video1_crop_height, 0, video1_crop_y_offset)
        if video2_crop_height is not None and video2_crop_y_offset is not None:
            video2 = video2.filter("crop", output_resolution[0], video2_crop_height, 0, video2_crop_y_offset)
        # Stack videos        
